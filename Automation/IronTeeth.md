# 🏭 Iron Teeth Automation Logic Sheet

## 🌱 Raw Resource Production

| Building | Resource | Resource Counter Min | Resource Counter Max | Memory : Set-Reset | Memory : Set-Reset | Resource Counter Empty 1  | Power Meter | Relay: AND | Relay: AND |
|----------|----------|----------------------|----------------------|---------------------|---------------------|---------------------------|-------------|-------------|-------------|
...
## ⚙️ Processing & Refining

| Building | Resource | Resource Counter Min | Resource Counter Max | Memory : Set-Reset | Memory : Set-Reset | Resource Counter Empty 1 | Resource Counter Empty 2 | Resource Counter Empty 3 | Power Meter | Relay: AND | Relay: AND | Relay: AND |
|----------|----------|----------------------|----------------------|---------------------|---------------------|---------------------------|---------------------------|---------------------------|-------------|-------------|-------------|-------------|
...
| Mine | Scrap Metal | Scrap Metal < 70% | Scrap Metal = 100% | A: Scrap Metal Min | RST: Scrap Metal Max | Treated Plank > 10% | Extract > 10% |  | Power Supply > 0 | Scrap Metal Reset | Treated Plank Empty | Power |  |  |
...
| Bot Part Factory | Bot Chassis | Bot Chassis < 70% | Bot Chassis = 100% | A: Bot Chassis Min | RST: Bot Chassis Max | Plank > 10% | Metal > 10% |  | Power Supply > 0 | Bot Chassis Reset | Plank Empty | Metal Empty | Power |  |
...
| Building | Resource Counter Empty 1 | Resource Counter Empty 2 | Power Meter | Relay: AND | Relay: AND |
|----------|---------------------------|---------------------------|-------------|-------------|-------------|
| Steam Engine | Water > 40% | Log > 10% | Surplus < 0 | Water Empty | Log Empty |

---

## 🧠 Science Systems

| Building | Science Counter Min | Science Counter Max | Memory : Set-Reset | Memory : Set-Reset | Power Meter | Relay: AND | Relay: AND |
|----------|---------------------|---------------------|---------------------|---------------------|-------------|-------------|-------------|
| Number Cruncher | Science < 5000 | Science > 100000 | A: Science Min | RST: Science Max | Surplus < 0 | Science Reset | Power |

| Building | Science Counter Min | Power Meter | Relay: AND | Relay: AND |
|----------|---------------------|-------------|-------------|-------------|
| Control Tower | Science > 20 | Power Supply > 0 | Science Min | Power |

---

## ☣️ Population / Special Systems

| Building | Population Counter Min | Population Counter Max | Memory : Set-Reset | Memory : Set-Reset | Resource Counter Empty 1 | Resource Counter Empty 2 | Resource Counter Empty 3 | Power Meter | Relay: AND | Relay: AND | Relay: AND | Relay: AND | Relay: AND |
|----------|------------------------|------------------------|---------------------|---------------------|---------------------------|---------------------------|---------------------------|-------------|-------------|-------------|-------------|-------------|-------------|
| Contamination Pod | Contaminated Beaver = 01 | Contaminated Beaver > 0 | A: Contaminated Beaver Max | RST: Contaminated Beaver Min | Extract > 10% |  |  | Power Supply > 0 | Contaminated Beaver Reset | Extract Empty | Power |  |  |
